...
using System;
using System.IO;
public class Mono_Master:MonoBehaviour
{
    /// <summary>
    /// 数据库连接定义
    /// </summary>
    ...
    public Mono_Master(string connectionString)
    {
        try
        {
            //构造数据库连接
    ...
    public SqliteDataReader CreateTable(string tableName, string tablePass)
    {
        return ExecuteQuery("");
    }
    ...
    public Mono_Master(string connectionString,int a )
