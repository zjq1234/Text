...
public class CreatPrefabsFromZJQ : MonoBehaviour
{
    /// <summary>
    /// 单例模式
    /// </summary>
    public static CreatPrefabsFromZJQ _PrefabGam//单例
    {
        get
        {
            if (_instance == null)
            {
                _instance = FindObjectOfType<CreatPrefabsFromZJQ>();
            }
            return _instance;
        }
    }
    private static CreatPrefabsFromZJQ _instance;
